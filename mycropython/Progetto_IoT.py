...
#Variabile globale orario programmato
scheduled_time = None
...
def get_local_time():
    # UTC+1 (Italia)
    t = time.localtime(time.mktime(time.localtime()) + 3600)
    return t
...
class MQTTManager:
    ...
    def on_message(self, topic, msg):
        ...
        if topic == self.topic_cmd and msg == b'dispense':
            ...
            scheduled_time = msg.decode('utf-8')
            print("Orario pianificato:", scheduled_time)
    ...
    def check_schedule(self):
        ...
        if scheduled_time:
            ...
            if current_time == scheduled_time:
                print("Orario programmato raggiunto, eseguo erogazione")
                self.execute_dispense()
                scheduled_time = None
