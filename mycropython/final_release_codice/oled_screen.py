...
def show_dispense_message():
    display.fill(0)
    display.text("Erogazione", 10, 28)
    display.text("in corso", 10, 34)
    display.show()
    time.sleep(2)
    draw_main_screen()

def show_early_dispense():
    display.fill(0)
    display.text("Erogazione", 0, 0)
    display.text("anticipata", 0, 10)
    display.show()
    time.sleep(2)
    draw_main_screen()
...
def show_ir_alert():
    display.fill(0)
    display.text("Quantita'", 0, 0)
    display.text("Eccessiva", 0, 10)
    display.show()
    time.sleep(2)
    draw_main_screen()


def show_wifi_status(connecting=True):
    display.fill(0)
    if connecting:
        display.text("Connessione", 10, 20)
        display.text("in corso...", 10, 35)
    else:
        display.text("Connessione", 10, 20)
        display.text("avvenuta!", 10, 35)
    display.show()
